    ...
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 px-4">
      <div className="max-w-4xl mx-auto text-center animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
          <Button onClick={() => window.open(process.env.LINKEDIN_PROFILE_URL, '_blank')} size="lg" className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white px-8 py-3">
            View My Work
          </Button>
        ...
        <div className="flex justify-center space-x-6">
          <a onClick = {() => window.open(process.env.GITHUB_PROFILE_URL, '_blank')} className="p-3 rounded-full bg-white shadow-md hover:shadow-lg transition-shadow hover-scale">
            <Github className="w-6 h-6 text-gray-700" />
          </a>
          <a href="#" className="p-3 rounded-full bg-white shadow-md hover:shadow-lg transition-shadow hover-scale">
